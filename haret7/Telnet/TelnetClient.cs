...
namespace haret7.Telnet
{
    public class TelnetClient
    {
        ...
        public event EventHandler<TelnetMessageReceivedFromServer> TelnetMessageReceivedFromServer;
        ...
        private void ProcessIncomingMessage(string telnetMessage)
        {
            Debug.WriteLine(telnetMessage);
            ...
            if (TelnetMessageReceivedFromServer != null)
                TelnetMessageReceivedFromServer(this, new TelnetMessageReceivedFromServer(telnetMessage));
        }
    }
}
